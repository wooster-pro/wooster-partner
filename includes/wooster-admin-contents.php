...
?>
    ...
    <div class="wooster-wrapper">
        <p><?= __('Intégrez facilement le badge où vous le souhaitez grâce aux shortcodes ci-dessous. <br>Nous recommandons de l\'intégrer sur la page d\'accueil. Il permet à vos clients de vérifier la validité de votre certificat de partenariat sur le site <b>wooster.fr</b>.', 'wooster-badge') ?></p>
        <div class="wooster-grid">
            ...
            <div class="wooster-box">
                <div class="wooster-box-content">
                    <?= wooster_partenaire_badge_light('856842569', '122301'); ?>
                </div>
            </div>
        </div>
        <div class="wooster-grid">
            <div class="wooster-box dark">
                <div class="wooster-box-content">
                    ...
                    <div class="wooster-box-body">
                        <div class="wooster-box-description">
                            <p class="wooster-box-action-button-text-primary"><?= __('Shortcode pour intégration :', 'wooster-badge') ?></p>
            ...
            <div class="wooster-box dark">
                <div class="wooster-box-content">
                    <?= wooster_partenaire_badge_dark('856842569', '122301'); ?>
                </div>
            </div>
        </div>
    </div>
...
?>
    ...
    <div class="wooster-wrapper">
        <div class="wooster-grid">
            <div>
                <p><?= __('Intégrez facilement le logo de Wooster où vous le souhaitez grâce au shortcode ', 'wooster-badge') ?><code>[wooster-logo]</code></p>
            </div>
            <div>
        ...
        <h3><?= __('Shortcode adaptatif', 'wooster-badge') ?></h3>
        <p><?= __('Vous pouvez adapter l\'affichage du logo en modifiant les paramètres du shortcode', 'wooster-badge') ?><code>[wooster-logo]</code><?= __(' comme ci-dessous :', 'wooster-badge') ?></p>
        <ul>
            <li><b><?= __('PNG, WebP et AVIF', 'wooster-badge') ?></b> : <?= __('Le meilleur format est automatiquement distribué par notre CDN.', 'wooster-badge') ?></li>
            <li> <b>SVG</b> : <?= __('Le SVG est intégré en HTML.', 'wooster-badge') ?></li>
        </ul>


        <?= wooster_logo_grid(
            __('Petit logo sur fond clair', 'wooster-badge'),
        ...
        <?= wooster_logo_grid(
            __('Petit logo sur fond sombre', 'wooster-badge'),
        ...
        <?= wooster_logo_grid(
            __('Moyen logo sur fond clair', 'wooster-badge'),
        ...
        <?= wooster_logo_grid(
            __('Moyen logo sur fond sombre', 'wooster-badge'),
        ...
        <?= wooster_logo_grid(
            __('Grand logo sur fond clair', 'wooster-badge'),
        ...
        <?= wooster_logo_grid(
            __('Grand logo sur fond sombre', 'wooster-badge'),
        ...
        <div class="wooster-grid custom-box">
            <div class="wooster-box w-500px">
                <div class="wooster-box-content">
                    <div class="wooster-box-header">
                        <h3 class="wooster-box-title"><?= __('Logo avec largeur personnalisée', 'wooster-badge') ?></h3>
                        <label for="custom-width"><?= __('Largeur', 'wooster-badge') ?></label>
                        <input type="number" name="custom-width" class="custom-width" placeholder="<?= __('ex : 100', 'wooster-badge') ?>" value="200"> px
                    </div>
                    <div class="wooster-box-body">
                        <div class="wooster-box-description">
            ...
            <div class="wooster-box w-500px">
                <div class="wooster-box-content">
                    <div class="wooster-box-header">
                        <h3 class="wooster-box-title"><?= __('Logo avec largeur personnalisée', 'wooster-badge') ?></h3>
                        <label for="custom-width"><?= __('Largeur', 'wooster-badge') ?></label>
                        <input type="number" name="custom-width" class="custom-width dark" placeholder="<?= __('ex : 100', 'wooster-badge') ?>" value="200"> px
                    </div>
                    <div class="wooster-box-body">
                        <div class="wooster-box-description">
                            <p class="wooster-box-action-button-text-primary">
        ...
        <h3><?= __('Personnalisation avancée du shortcode ', 'wooster-badge') ?><code>[wooster-logo]</code></h3>
        <table class="wp-list-table widefat striped table-view-list" style="margin: 30px 0;">
            <thead>
                <tr>
                    <th style="padding-left: 10px;"><span><?= __('Paramètre', 'wooster-badge') ?></span></th>
                    <th><?= __('Description', 'wooster-badge') ?></th>
                    <th><?= __('Valeurs possibles', 'wooster-badge') ?></th>
                    <th><?= __('Exemples', 'wooster-badge') ?></th>
                </tr>
            </thead>
            ...
            <tbody id="the-list">
                <tr>
                    ...
                    <td style="max-width: 250px;"><strong><?= __('Type d\'image du logo', 'wooster-badge') ?></strong><br>
                        <?= __('Le logo est disponible aux formats :', 'wooster-badge') ?>
                        <ul style="padding-left: 20px; list-style-type: disc;">
                            <li><?= __('PNG, WebP et AVIF.', 'wooster-badge') ?> : <?= __('Le meilleur format est automatiquement distribué par notre CDN.', 'wooster-badge') ?></li>
                            <li><?= __('SVG', 'wooster-badge') ?> : <?= __('Le SVG est intégré en HTML.', 'wooster-badge') ?></li>
                        </ul>
                    </td>
                    <td>
                        <ul>
                            <li><code>img</code> <?= __('pour les format PNG, WebP ou AVIF.', 'wooster-badge') ?></li>
                            <li><code>svg</code> <?= __('pour le format SVG.', 'wooster-badge') ?></li>
                        </ul>
                    </td>
                    <td>
                        <ul>
                ...
                <tr>
                    ...
                    <td style=" max-width: 250px;"><strong><?= __('Version du logo', 'wooster-badge') ?></strong><br>
                        <?= __('Sélectionner la version du logo adaptée à un fond clair ou sombre.', 'wooster-badge') ?><br>
                    </td>
                    <td>
                        <ul>
                            <li><code>clair</code> <?= __('pour l\'affichage du logo sur un fond clair.', 'wooster-badge ') ?></li>
                            <li><code>sombre</code> <?= __('pour l\'affichage du logo sur un fond sombre.', 'wooster-badge') ?></li>
                        </ul>
                    </td>
                    <td>
                        <ul>
                ...
                <tr>
                    ...
                    <td style=" max-width: 250px;">
                        <strong><?= __('Dimmension du logo', 'wooster-badge') ?></strong><br>
                        <?= __('Choisir une taille prédéfinie.', 'wooster-badge') ?>
                    </td>
                    <td>
                        <ul>
                ...
                <tr>
                    ...
                    <td style=" max-width: 250px;">
                        <strong><?= __('Largeur du logo', 'wooster-badge') ?></strong><br>
                        <?= __('Lorsque vous indiquez une largeur et une hauteur en même temps dans le shortcode, la hauteur est automatiquement réécrite pour conserver les proportions du logo.', 'wooster-badge') ?>
                    </td>
                    <td>
                        <ul>
                            <li><code>xxx</code> (xxx px) : <?= __('largeur personnalisée en px', 'wooster-badge') ?></li>
                        </ul>
                    </td>
                    <td>
                        <ul>
                ...
                <tr>
                    ...
                    <td>
                        <strong><?= __('Hauteur du logo', 'wooster-badge') ?></strong><br>
                        <?= __('N\'indiquez pas de largeur si vous souhaitez que la hauteur soit appliquée.', 'wooster-badge') ?>
                    </td>
                    <td>
                        <ul>
                            <li><code>xxx</code> (xxx px) : <?= __('hauteur personnalisée en px', 'wooster-badge') ?></li>
                        </ul>
                    </td>
                    <td>
                        <ul>
            ...
            <tfoot>
                <tr>
                    <th><span><?= __('Paramètre', 'wooster-badge') ?></span></th>
                    <th><?= __('Description', 'wooster-badge') ?></th>
                    <th><?= __('Valeurs possibles', 'wooster-badge') ?></th>
                    <th><?= __('Exemples', 'wooster-badge') ?></th>
                </tr>
